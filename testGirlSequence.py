...
parser.add_argument('--threshold', type=float, default=0.02, help='dp threshold of Lucas-Kanade for terminating optimization')
...
for frameNum in [1, 20, 40, 60, 80]:
    ...
    plt.savefig("../images/1_3_girl_{}.png".format(frameNum), pad_inches=0, bbox_inches='tight', transparent=True)
